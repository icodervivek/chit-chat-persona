...
export default function Hitesh() {
  ...
  useEffect(() => {
    setChat([
      {
        sender: "hitesh",
        text: "Haanji! Kya haal chaal? 👋 Code vagera theek chal raha hai na? Chai aap le aao, code hum krwa denge! 😉",
  ...
  const handleSend = async () => {
    ...
    try {
      const res = await fetch("/api/hitesh", {
        method: "POST",
